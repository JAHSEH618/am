 ...
 *   - 单一强调色 = 品牌靛紫 indigo-600 #4f46e5，与 logo / 字标同源；不再有「功能蓝
 *     #2563eb vs 品牌靛紫」的分裂。强调色只用于主操作 / 选中 / 当前态 / 状态指示，不做装饰。
...
/** 品牌主色阶 —— 与既有 logo(#6366f1)/字标(#4f46e5)/Hero ring(#c7d2fe) 像素级对齐 */
export const indigo = {
  50: '#eef2ff',
  100: '#e0e7ff',
  200: '#c7d2fe',
  ...
  400: '#818cf8',
  500: '#6366f1',
  600: '#4f46e5', // ← 主强调色 (primary)
  700: '#4338ca',
  800: '#3730a3',
  900: '#312e81',
} as const;

/** 紫罗兰伴生色 —— 只用于品牌渐变与极少数强调收尾，不做功能色 */
export const violet = {
  400: '#a78bfa',
  500: '#8b5cf6', // ← BrandIcon 渐变终点
  600: '#7c3aed', // ← 字标渐变中点
} as const;
...
/** 字标 / 品牌位渐变（全站唯一允许的渐变文字，仅此一处） */
export const brandGradient =
  'linear-gradient(118deg, #4f46e5 0%, #7c3aed 52%, #6366f1 100%)';
