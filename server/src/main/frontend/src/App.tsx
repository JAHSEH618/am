  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/analysis" element={<Suspense fallback={<PageFallback />}><Analysis /></Suspense>} />
        <Route path="/projects" element={<Suspense fallback={<PageFallback />}><Projects /></Suspense>} />
        <Route path="/models-tools" element={<Suspense fallback={<PageFallback />}><ModelsTools /></Suspense>} />
        <Route path="/alerts" element={<Alerts />} />
        <Route path="/system" element={<Suspense fallback={<PageFallback />}><SystemSettings /></Suspense>} />
